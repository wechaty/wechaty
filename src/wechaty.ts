...
export class Wechaty extends Accessory implements Sayable {
  ...
  public emit (event: 'login' | 'logout', user: ContactSelf, reason?: string)                           : boolean
  ...
  public on (event: 'login' | 'logout', listener: string | ((this: Wechaty, user: ContactSelf, reason?: string) => void))                           : this
