...
export const PUPPET_DEPENDENCIES = {
   ...
   */
  'wechaty-puppet-hostie'    : '^0.9.1',   // https://www.npmjs.com/package/wechaty-puppet-hostie
  'wechaty-puppet-mock'      : '^0.22.39',   // https://www.npmjs.com/package/wechaty-puppet-mock
