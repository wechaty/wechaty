...
export const PUPPET_DEPENDENCIES = {
   ...
   */
  'wechaty-puppet-service' : '>=0.37.11', // https://www.npmjs.com/package/wechaty-puppet-service
  'wechaty-puppet-mock'    : '>=0.33.3',  // https://www.npmjs.com/package/wechaty-puppet-mock
